        ...
        <div>
            <fieldset>
                ...
                <div onchange="mostrar();">
                    <select id="modulos" name="selectCurso">
                ...
                <div id="moduloPhp">
                    <input type="checkbox" name="Modulo[]" value="arrays">
                    Arreglos
                </input>
                <br>
                <input type="checkbox" name="Modulo[]" value="archivos">
                Archivos
            </input>
            <br>
            <input type="checkbox" name="Modulo[]" value="ado">
            ADO
        </input>
        <br>
    </div>
    <div id="moduloCocina">
        <input type="checkbox" name="Modulo[]" value="pan">
        Pan
    </input>
    <br>
    <input type="checkbox" name="Modulo[]" value="sopas">
    Sopas
</input>
<br>
<input type="checkbox" name="Modulo[]" value="salsas">Salsas
</input>
<br>
</div>
</fieldset>
...
if (isset($_REQUEST['Aceptar'])) {
    if (!empty($_POST['nombre']) && !empty($_POST['apellido'])) {
        ...
        if ($_POST['selectCurso'] == "php") {
            $_SESSION['contPHP'] ++;
        } else
            if ($_POST['selectCurso'] == "cocina") {
            $_SESSION['contCocina'] ++;
        }
    }
}
